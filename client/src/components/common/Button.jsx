...
const Button = ({
  ...
  const variants = {
    ...
    secondary:
      'bg-secondary-500 text-white hover:bg-secondary-600 focus:ring-secondary-500 shadow-lg shadow-secondary-500/30',
    outline:
      'bg-white text-primary-600 border-2 border-primary-100 hover:border-primary-200 hover:bg-primary-50 focus:ring-primary-500',
    ghost:
